...
low/medium/high/xhigh/max efforts. Review task assignments follow Sol and Luna; all supported Luna efforts are active, with low limited to phase reviews. `gpt-6-astra-minor` remains disabled and excluded
